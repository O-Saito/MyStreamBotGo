...
func (*PageInfo) Descriptor() ([]byte, []int) {
	return file_stream_list_proto_rawDescGZIP(), []int{21}
}
...
func (x *LiveChatPollDetails_PollMetadata_PollOption) Reset() {
	*x = LiveChatPollDetails_PollMetadata_PollOption{}
	mi := &file_stream_list_proto_msgTypes[26]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
const file_stream_list_proto_rawDesc = "" +
	...
	"\n" +
	"StreamList\x12*.youtube.api.v3.LiveChatMessageListRequest\x1a+.youtube.api.v3.LiveChatMessageListResponse\"\x000\x01B&Z$MyStreamBot/services/youtube;youtube"
...
var file_stream_list_proto_msgTypes = make([]protoimpl.MessageInfo, 27)
